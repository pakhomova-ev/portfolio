...
### Обо мне
Прошла обучение на тестировщика в Skypro, изучаю автоматизацию на Java в онлайн школе Redrover school. 
В тестирование для меня привлекательны сферы: интеграционное тестирование (АПИ),  автоматизация простых повторяющихся проверок, чтобы высвободиться ресурсов тестировщика для прохождения сложных сценариев и локализацию дефектов.  
...
Ссылка на [репозиторий проекта](https://github.com/pakhomova-ev/final_project_skypro.git)
